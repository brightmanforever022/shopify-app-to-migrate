ShopifyApp.configure do |config|
  ...
  config.scope = "read_products,write_products,read_themes,write_themes,read_customers,write_customers,write_draft_orders,read_draft_orders,read_price_rules,read_discounts,read_product_listings" # Consult this page for more scope options:
